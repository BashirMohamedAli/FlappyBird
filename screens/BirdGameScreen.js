...
const BirdGameScreen = () => {
  const {width, height} = useWindowDimensions();
  const [score, setScore] = useState(0);

  const bg = useImage(require('../assets/background.png'));
  const bird = useImage(require('../assets/bird.png'));
  const pipeBottom = useImage(require('../assets/pipe-bottom.png'));
  const pipeTop = useImage(require('../assets/pipe-top.png'));
  const base = useImage(require('../assets/base.png'));
